...
namespace Xceed.Words.NET
{
    ...
    public class Paragraph : InsertBeforeOrAfter
    {
        ...
        {
            List<XNode> rList = new List<XNode>(3); // r list between bookmarkstart and bookmarkend
            ...
            var curBookStartId = bookmarkStart.Attribute(XName.Get("id", DocX.w.NamespaceName)).Value;  //current bookmarkstart id
            ...
            while (nextNode != null)
            {
                ...
                if ((nextXElement != null) && (nextXElement.Name.NamespaceName == DocX.w.NamespaceName) && (nextXElement.Name.LocalName == "r"))
                {
            ...
            else
            {
                ...
                {
                    var tXElement = (rList[i] as XElement).Elements(XName.Get("t", DocX.w.NamespaceName)).FirstOrDefault();
                    if (tXElement == null)
                    {
                        this.ReplaceAtBookmark_Core(text, bookmarkStart);
                    }
