...
namespace Xceed.Words.NET
{
    ...
    public class DocX : Container, IDisposable
    {
        ...
        /// </summary>
        public void InsertChart(Chart chart, int width = 575, int height = 335)
        {
        ...
        public void InsertChartAfterParagraph(Chart chart, Paragraph paragraph, int width = 575, int height = 335)
        {
            this.InsertChart(chart, paragraph, width, height);
        }

        private void InsertChart(Chart chart, Paragraph paragraph, int p_width = 575, int p_height = 335)
        {
            Paragraph p;
            ...
            int width = p_width * 9526;
            int height = p_height * 9526;
            ...
            var chartElement = new XElement(XName.Get("r", w.NamespaceName),
                                        new XElement(XName.Get("drawing", w.NamespaceName),
                                                        new XElement(XName.Get("inline", wp.NamespaceName),
                                                                    new XElement(XName.Get("extent", wp.NamespaceName), new XAttribute("cx", width), new XAttribute("cy", height)),
