  ...
  public class Paragraph : InsertBeforeOrAfter
  {
    ...
    public float IndentationFirstLine
    {
      ...
      set
      {
        if( IndentationFirstLine != value )
        {
          ...
          string indentation = ( ( indentationFirstLine / 0.1 ) * 57 ).ToString( CultureInfo.InvariantCulture );
          XAttribute firstLine = ind.Attribute( XName.Get( "firstLine", Document.w.NamespaceName ) );
          if( firstLine != null )
    ...
    public float IndentationBefore
    {
      ...
      set
      {
        if( IndentationBefore != value )
        {
          ...
          var indentation = ( ( indentationBefore / 0.1 ) * 57 ).ToString( CultureInfo.InvariantCulture );
    ...
    public float IndentationAfter
    {
      ...
      set
      {
        if( IndentationAfter != value )
        {
          ...
          var indentation = ( ( indentationAfter / 0.1 ) * 57 ).ToString( CultureInfo.InvariantCulture );
    ...
    public Alignment Alignment
    {
      ...
      set
      {
        ...
        if( alignment != Xceed.Document.NET.Alignment.left )
        {
          if( jc == null )
    ...
    internal Paragraph( Document document, XElement xml, int startIndex, ContainerType parentContainerType = ContainerType.None ) : base( document, xml )
    {
      ...
      _runs = Xml.Elements( XName.Get( "r", Document.w.NamespaceName ) ).ToList();
    }
    ...
    public Paragraph Append( string text )
    {
      ...
      _runs = Xml.Elements( XName.Get( "r", Document.w.NamespaceName ) ).Reverse().Take( newRuns.Count() ).ToList();
    ...
    public Paragraph AppendHyperlink( Hyperlink h )
    {
      ...
      Xml.Add( h.Xml );
      Xml.Elements().Last().SetAttributeValue( Document.r + "id", Id );

      _runs = Xml.Elements().Last().Elements( XName.Get( "r", Document.w.NamespaceName ) ).ToList();
    ...
    public Paragraph AppendEquation( String equation )
    {
      ...
      Xml.Add( oMathPara );
      _runs = Xml.Elements( XName.Get( "oMathPara", Document.m.NamespaceName ) ).ToList();
    ...
    {
      ApplyTextFormattingProperty( XName.Get( "b", Document.w.NamespaceName ), string.Empty, null );
      return this;
    }
    ...
    {
      ApplyTextFormattingProperty( XName.Get( "i", Document.w.NamespaceName ), string.Empty, null );
      return this;
    }
    ...
    {
      ApplyTextFormattingProperty( XName.Get( "kern", Document.w.NamespaceName ), string.Empty, new XAttribute( XName.Get( "val", Document.w.NamespaceName ), kerning * 2 ) );
      return this;
    }
    ...
    {
      if( !( percentageScale >= 1 && percentageScale <= 600 ) )
    ...
    public void SetLineSpacing( LineSpacingType spacingType, float spacingFloat )
    {
      ...
      spacing.SetAttributeValue( XName.Get( spacingTypeAttribute, Document.w.NamespaceName ), ( int )( spacingFloat * 240f ) );
    }
    ...
    public Paragraph AppendBookmark( string bookmarkName )
    {
      XElement wBookmarkStart = new XElement(
          ...
          new XAttribute( XName.Get( "id", Document.w.NamespaceName ), 0 ),
    ...
    public void ReplaceAtBookmark( string text, string bookmarkName )
    {
      ...
      foreach( var r in rList )
      {
        ...
        {
          tXElement.Value = !tXElementFilled ? text : "";
    ...
    public void InsertHorizontalLine( HorizontalBorderPosition position = HorizontalBorderPosition.bottom, string lineType = "single", int size = 6, int space = 1, string color = "auto" )
    {
      ...
      if( pBdr == null )
      {
        ...
        border.SetAttributeValue( XName.Get( "color", Document.w.NamespaceName ), color );
      }
    }
    ...
    static internal Picture CreatePicture( Document document, string id, string name, string descr, int width, int height )
    {
      ...
      using( PackagePartStream packagePartStream = new PackagePartStream( part.GetStream() ) )
      {
        ...
        {
          cx = (long)img.Width * 914400 / Convert.ToInt64( img.HorizontalResolution );
          cy = (long)img.Height * 914400 / Convert.ToInt64( img.VerticalResolution );
        }
      }
